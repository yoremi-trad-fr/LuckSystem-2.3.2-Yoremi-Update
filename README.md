...
27. **Script plugin auto-selection + Dialogue GUI LOG_BEGIN hardening + Linux GUI build fix** — `cmd/scriptDecompile.go`, `cmd/scriptImport.go`, `SourcesGUI-wails/app.go`, `SourcesGUI-wails/frontend/package.json`
