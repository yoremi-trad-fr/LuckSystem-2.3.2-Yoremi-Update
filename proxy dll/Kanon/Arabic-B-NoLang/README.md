...
This test variant keeps the original visible language names (`日本語`, `English`, `简体中文`) to check whether patching those labels affects the in-game dialogue language slot.
