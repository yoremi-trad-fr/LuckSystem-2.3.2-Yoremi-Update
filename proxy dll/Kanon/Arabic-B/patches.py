...
JP_SLOT_PATCHES = [
    ...
    (0x487448, J("日本語"), "عربي", "Language switcher JP slot", "Arabic label for Japanese slot"),
...
ENGLISH_FALLBACK_PATCHES = [
    # Language list label that is visible while using the Japanese slot.
    (0x487460, J("简体中文"), "Chinese", "Language switcher Chinese label", "ASCII fallback"),
...
def main():
    ...
    base.PATCH_GAME_NAME = "Kanon Arabic-B JP slot"
    base.PATCH_VERSION = "0.6-ar-en-mixed"
