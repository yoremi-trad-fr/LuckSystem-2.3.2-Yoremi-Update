# LuckSystem GUI (Linux) — Yoremi fork v3.31
...
> **v3.31 platform note:** `DLL HOOK -> Luca Menu DLL` is available only in
...
- No Luca menu proxy-DLL generator in the native Linux GUI
